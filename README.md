...
| **Operators** | Manage funding operations and earn protocol fees |
...
**Concrete example — a $50,000 invoice with 30-day terms and 1% fee:**

| Step | Action | USDC Flow |
|------|--------|-----------|
| 1 | Supplier creates invoice for $50,000 | — |
| 2 | Buyer approves the invoice on-chain | — |
| 3 | Operator triggers funding from LP pool | 50,000 USDC → Supplier |
| 4 | Supplier receives instant payment | Supplier has 50,000 USDC |
| 5 | Buyer repays at maturity (Day 30) | 50,500 USDC → Pool |
| 6 | LPs earn the $500 fee via share price increase | SEED shares worth more |
...
### Buyer
Reviews and approves supplier invoices on-chain. Approval signals creditworthiness to the pool. The buyer repays the full amount plus fee at the original maturity date.
...
### Operator
Triggers funding for approved invoices, manages pool parameters, and oversees treasury strategy allocation. The operational backbone of the protocol.
